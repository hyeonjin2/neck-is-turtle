...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDialog.setContentView(R.layout.dialog_join);
        ...
        if(email.length() > 0) {
            ...
            if(check.length() > 0) {
                ...
                if (Objects.equals(check, check_pw)) {
                    Toast.makeText(LoginActivity.this, "일치합니다!"
                            , Toast.LENGTH_SHORT).show();
                    b_email_ch = true;
                }else {
                    Toast.makeText(LoginActivity.this, "일치하지 않습니다. 다시 입력해주세요!"
                            , Toast.LENGTH_SHORT).show();
                    b_email_ch = false;
                }
            }
            else
                Toast.makeText(LoginActivity.this, "인증번호를 입력해주세요!"
                        , Toast.LENGTH_SHORT).show();
        }
        else
            Toast.makeText(LoginActivity.this, "이메일을 입력해주세요!"
                    , Toast.LENGTH_SHORT).show();
    }
...
//            queue.add(registerRequest);
            ...
            if(!b_name){
                Toast.makeText(LoginActivity.this, "닉네임을 입력해주세요!"
                        , Toast.LENGTH_SHORT).show();
            }
            else if(!b_name_ch){
                Toast.makeText(LoginActivity.this, "닉네임 중복확인을 해주세요!"
                        , Toast.LENGTH_SHORT).show();
            }
            else if(!b_email){
                Toast.makeText(LoginActivity.this, "이메일을 입력해주세요!"
                ...
                Toast.makeText(LoginActivity.this, "비밀번호를 다시 한번 입력해주세요!"
                        , Toast.LENGTH_SHORT).show();
            }
        }
    }
